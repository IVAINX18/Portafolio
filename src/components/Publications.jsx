            ...
            <div className="relative z-10">
              ...
              <div className="mb-8">
                ...
                <div className="flex items-center gap-3 text-slate-400">
                  ...
                  <span className="font-mono text-sm">IEEE Xplore Digital Library</span>
                </div>
              </div>

              <div className="grid sm:grid-cols-2 gap-6 mb-8">
                <div className="bg-dark/50 border border-slate-800 rounded-lg p-4">
                  <p className="text-sm text-slate-500 mb-1">Publisher</p>
                  <p className="text-lg font-semibold text-slate-200">IEEE</p>
                </div>
                <div className="bg-dark/50 border border-slate-800 rounded-lg p-4">
                  <p className="text-sm text-slate-500 mb-1">Document ID</p>
                  <p className="text-lg font-semibold font-mono text-slate-200">11214618</p>
                </div>
              </div>

              <motion.a
                href="https://ieeexplore.ieee.org/document/11214618"
                target="_blank"
